...
class subjects(delegate.page):
    ...
    def GET(self, key):
        ...
        # Curated Tag bodies call {{QueryCarousel(...)}}; on subject pages that
        # macro renders the ol-books-display component instead of lazy-carousel.
        delegate.context.books_display = True
